...
if (workEx == null || workEx == undefined || !workEx) throw "Pleae enter 0 if you dont have work experience"
if (typeof workEx !== 'number') throw "Work Experience should be a number"
if (workEx < 0 || workEx > 100) throw "Please enter 0 if you dont have work experience"
...
async function updateUser(id, newUserData) {
    try {
        ...
        let uu = await profileUpdate.updateOne({ "_id": ObjectId(id) }, { $set: newUserData });
        return true;
    }
    catch (error) {
        return false;
