...
async function main() {
  ...
  await profilesCollection.updateOne(
    ...
    { $push: { favouriteUniversities: "The University of Texas at Dallas" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: "Stevens Institute of Technology" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    {
      $push: {
        favouriteUniversities: "Rutgers, The State University of New Jersey",
      },
    }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: "Montclair State University" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: "University of Southern California" } }
  );
  ...
  await profilesCollection.updateOne(
    ...
    {
      $push: {
        favouriteUniversities: "University of California, Santa Barbara",
      },
    }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    {
      $push: { favouriteUniversities: "Massachusetts Institute of Technology" },
    }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: "Fairleigh Dickinson University" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: "University of Southern California" } }
  ...
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: "Seton Hall University" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: "New Jersey Institute of Technology" } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: "University at Albany" } }
  );
  await profilesCollection.updateOne(
  ...
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["3"] },
    { $push: { favouriteUniversities: "Boston University" } }
  );
  await profilesCollection.updateOne(
