...
async function main() {
  ...
  universities[1].rating.push({
    userId: profilesInsertInfo.insertedIds["0"],
    givenRating: 4,
  });
  universities[1].rating.push({
    userId: profilesInsertInfo.insertedIds["2"],
    givenRating: 4,
  });
  universities[1].overallRating = 4; //average of the three ratings calculated manually
  universities[2].rating.push({
    userId: profilesInsertInfo.insertedIds["3"],
    givenRating: 5,
  });
  universities[2].rating.push({
    userId: profilesInsertInfo.insertedIds["4"],
    givenRating: 5,
  });
  universities[2].rating.push({
    userId: profilesInsertInfo.insertedIds["1"],
    givenRating: 5,
  });
  ...
  await profilesCollection.updateOne(
    ...
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["4"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["10"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["43"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["30"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["1"] } }
  );

  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["23"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["34"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["24"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["44"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["36"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["41"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["22"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["14"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["3"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["18"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["3"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["19"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["4"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["38"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["4"] },
    { $push: { favouriteUniversities: uniInsertInfo.insertedIds["11"] } }
  );

  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["0"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["1"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["2"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["3"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["3"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["4"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["11"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["0"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["10"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["1"] },
    { $push: { commentOnPost: commentsInsertInfo.insertedIds["9"] } }
  );
  await profilesCollection.updateOne(
    { _id: profilesInsertInfo.insertedIds["2"] },
